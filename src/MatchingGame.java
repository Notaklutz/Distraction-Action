...
public class MatchingGame extends GameLevel 
{
  ...
  {
    images[0] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Water.png"));
    images[1] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Water.png"));
    images[2] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Music.png"));
    images[3] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Music.png"));
    images[4] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Hourglass.png"));
    images[5] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Hourglass.png"));
    images[6] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Headphones.png"));
    images[7] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\Headphones.png"));
    images[8] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\NoPhones.png"));
    images[9] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\NoPhones.png"));
    images[10] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\TextMessage.png"));
    images[11] = new ImageIcon(getClass().getResource("\\Resources\\MatchingGameCards\\SocialMedia.png"));
    ...
    {
      backCards[x] = cardCreator(new ImageIcon (getClass().getResource("\\Resources\\MatchingGameCards\\Back.png")));
  ...
  {      
    ...
    while (!stop && x != 12) // while loop to check each button in backCards to determine where the ActionEvent came from
    {  
