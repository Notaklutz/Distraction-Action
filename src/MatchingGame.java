...
public class MatchingGame extends GameLevel 
{
  ...
  {
    images[0] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Water.png"));
    images[1] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Water.png"));
    images[2] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Music.png"));
    images[3] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Music.png"));
    images[4] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Hourglass.png"));
    images[5] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Hourglass.png"));
    images[6] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Headphones.png"));
    images[7] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\Headphones.png"));
    images[8] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\NoPhones.png"));
    images[9] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\NoPhones.png"));
    images[10] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\TextMessage.png"));
    images[11] = new ImageIcon(getClass().getResource("\\Pictures\\MatchingGameCards\\SocialMedia.png"));
    ...
    {
      backCards[x] = cardCreator(new ImageIcon (getClass().getResource("\\Pictures\\MatchingGameCards\\Back.png")));
