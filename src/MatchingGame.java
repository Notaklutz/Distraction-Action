 ...
 * with the distractions on them more than twice. This class extends GameLevel and ActionListener.
 * <br>
 * Time Spent: 8 hours
 * </p>
 * <p>
 * <pre>
 * Change Log
 * May 30, 2019 - Created MatchingGame class and added functionality with buttons displaying Strings.
 * May 31, 2019 - Changed functionality to work with pngs.
 * June 1, 2019 - Finished MatchingGame, complete with pngs and strike system. Made MatchingGame extend
 *                GameLevel.
 * June 2, 2019 - Changed printText() to displayGame(). Updated encapsulation of methods.
 * </pre>
 * </p>
 */ 
public class MatchingGame extends GameLevel 
{
  /**
  ...
  {
    images[0] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Water.png"));
    images[1] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Water.png"));
    images[2] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Music.png"));
    images[3] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Music.png"));
    images[4] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Hourglass.png"));
    images[5] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Hourglass.png"));
    images[6] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Headphones.png"));
    images[7] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Headphones.png"));
    images[8] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/NoPhones.png"));
    images[9] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/NoPhones.png"));
    images[10] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/TextMessage.png"));
    images[11] = new ImageIcon(DistractionAction.class.getClassLoader().getResource("MatchingGameCards/SocialMedia.png"));
    
    matches = new JLabel("Matches: " + numMatches);
    strikes = new JLabel("Strikes: " + numStrikes);
    
    matches.setFont(matchFont);
    ...
    {
      backCards[x] = cardCreator(new ImageIcon (DistractionAction.class.getClassLoader().getResource("MatchingGameCards/Back.png")));
  ...
  protected void printResults() 
  {
    ...
    if (numStrikes >= 3)
      result.setFont(matchResultFont);
    else
      result.setFont(matchFont);
  ...
  {      
    ...
    stop = false;
    if (end() && e.getSource() != nextLevelOrLevelSelection && e.getSource() != tryAgain) // Checks for win condition
    {    
