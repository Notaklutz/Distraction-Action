 ...
 * general instructions of the game. This class extends TextOnly and implements KeyListener.
 * </p>
 */
public class Instructions extends TextOnly implements KeyListener
{
  /**
  ...
  /**
   * This method will call the mainMenu() method in DistractionAction.
   ...
   * line1                    JLabel               The JLabel that will display "In the Panic Room, you will have to press the".
   * line2                    JLabel               The JLabel that will display "spacebar to jump and avoid distractions while".
   * line3                    JLabel               The JLabel that will display "collecting boosts. Try to avoid the distractions".
   * line4                    JLabel               The JLabel that will display "and get as many boosts as you can to cross".
   * line5                    JLabel               The JLabel that will display "the finish line within the time limit.".
   * line6                    JLabel               The JLabel that will display "Press any key to continue.".
   * </pre>
   * </p>
   * @param p A throwaway int parameter that is used to distinguish the correct printText() method for the instructions of the Panic Room.
   */ 
  public void printText(int p)
  {
    ...
    JLabel line1 = new JLabel ("In the Panic Room, you will have to press the"); 
    line1.setFont (defaultFont);
    line1.setForeground(Color.white);
    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, line1, 0, SpringLayout.HORIZONTAL_CENTER, this);
    layout.putConstraint(SpringLayout.NORTH, line1, 150, SpringLayout.SOUTH, game.frame);
    ...
    JLabel line2 = new JLabel ("spacebar to jump and avoid distractions while");
    line2.setFont (defaultFont);
    line2.setForeground(Color.white);
    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, line2, 0, SpringLayout.HORIZONTAL_CENTER, this);
    layout.putConstraint(SpringLayout.NORTH, line2, 50, SpringLayout.SOUTH, line1);
    ...
    JLabel line3 = new JLabel ("collecting boosts. Try to avoid the distractions");
    line3.setFont (defaultFont);
    line3.setForeground(Color.white);
    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, line3, 0, SpringLayout.HORIZONTAL_CENTER, this);
    layout.putConstraint(SpringLayout.NORTH, line3, 50, SpringLayout.SOUTH, line2);
    ...
    JLabel line4 = new JLabel ("and get as many boosts as you can to cross");
    line4.setFont (defaultFont);
    line4.setForeground(Color.white);
    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, line4, 0, SpringLayout.HORIZONTAL_CENTER, this);
    layout.putConstraint(SpringLayout.NORTH, line4, 50, SpringLayout.SOUTH, line3);
    ...
    JLabel line5 = new JLabel ("the finish line within the time limit.");
    line5.setFont (defaultFont);
    line5.setForeground(Color.white);
    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, line5, 0, SpringLayout.HORIZONTAL_CENTER, this);
    layout.putConstraint(SpringLayout.NORTH, line5, 50, SpringLayout.SOUTH, line4);
   ...
   * </pre>
   * </p>
   * @param e A throwaway String parameter that is used to distinguish the correct printText() method for the instructions of the Escape Room.
   */ 
  public void printText(String e)
  {
