 ...
 * <pre>
 * Change Log
 * May 12, 2019 - Created and finished SplashScreen class
 * </pre>
 * </p>
 */ 
public class SplashScreen extends JPanel {
     ...
     */
    private JLabel logo = new JLabel(new ImageIcon(DistractionAction.class.getClassLoader().getResource("SplashScreen/SplashScreen2.png")));

    /**
     * The game logo to be displayed.
     */
    private JLabel logo2 = new JLabel(new ImageIcon(DistractionAction.class.getClassLoader().getResource("SplashScreen/SplashScreen.png")));
