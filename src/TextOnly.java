...
public abstract class TextOnly extends JPanel {
    ...
    /**
     * The dark grey colour that is used in the game's background.
     */
    protected static final Color GREY = new Color(64, 64, 64);
    /**
    ...
    public void printTitle() {
        ...
        bigD.setText("D");
        layout.putConstraint(SpringLayout.WEST, bigD, 20, SpringLayout.WEST, DistractionActionDriver.frame);
        layout.putConstraint(SpringLayout.NORTH, bigD, 10, SpringLayout.NORTH, DistractionActionDriver.frame);
        this.add(bigD);
        ...
        layout.putConstraint(SpringLayout.NORTH, midTitle, 10, SpringLayout.NORTH, DistractionActionDriver.frame);
        this.add(midTitle);
        bigN.setFont(bigTitle);
        bigN.setForeground(YELLOW);
        bigN.setText("N");
        layout.putConstraint(SpringLayout.WEST, bigN, -5, SpringLayout.EAST, midTitle);
        layout.putConstraint(SpringLayout.NORTH, bigN, 10, SpringLayout.NORTH, DistractionActionDriver.frame);
        this.add(bigN);
    }
    ...
    public void printFooter() {
        ...
        layout.putConstraint(SpringLayout.WEST, footer1, 340, SpringLayout.WEST, DistractionActionDriver.frame);
        layout.putConstraint(SpringLayout.SOUTH, footer1, 750, SpringLayout.NORTH, DistractionActionDriver.frame);
        this.add(footer1);
        ...
        layout.putConstraint(SpringLayout.SOUTH, footer2, 750, SpringLayout.NORTH, DistractionActionDriver.frame);
        this.add(footer2);
    }

    /**
     * This is a generic print method that will be overridden by TextOnly's subclasses.
     */
