...
public abstract class Screen extends JPanel
{
  ...
  {
    File pixelFont = new File(System.getProperty("user.dir") + "\\Resources\\Fonts\\Apple.ttf");
    try
    {
      bigTitle = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(Font.BOLD, 80f);
      smallTitle = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(Font.BOLD, 47f);
      buttonFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(Font.BOLD, 40f);
      highScoresAndGoodbyeFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(30f);
      creditsFont = highScoresAndGoodbyeFont;
      bookFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(13f);
      defaultFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(20f);
      quizFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(25f);
      quizResultFont = smallTitle;
      choiceFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(27f);
      matchFont = buttonFont;
      matchResultFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(Font.BOLD, 27f);
      playerNameFont =  buttonFont;
      dodgingResultFont = Font.createFont(Font.TRUETYPE_FONT, pixelFont).deriveFont(Font.BOLD, 35f);
