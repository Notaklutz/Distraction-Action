...
public class LevelOneBook extends Screen implements ActionListener, KeyListener{
   ...
   */   
  private JLabel background = new JLabel(new ImageIcon(getClass().getResource("\\Resources\\Book\\Library.jpg")));
  /**
   *  The book to be displayed. Labeled Distactions 101, and is empty. Will be filled though the use
   *  of JLabels.
   */
  private JLabel book = new JLabel(new ImageIcon(getClass().getResource("\\Resources\\Book\\Book.png")));
  /**
