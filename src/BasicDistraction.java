...
class BasicDistraction extends GameObject {
    /**
    ...
    public void initSprites() {
        try {
            distractions.add(ImageIO.read(DistractionAction.class.getResourceAsStream("LevelThree/facebook.png")));
            distractions.add(ImageIO.read(DistractionAction.class.getResourceAsStream("LevelThree/twitter.png")));
            distractions.add(ImageIO.read(DistractionAction.class.getResourceAsStream("LevelThree/email.png")));
            distractions.add(ImageIO.read(DistractionAction.class.getResourceAsStream("LevelThree/notification.png")));
            distractions.add(ImageIO.read(DistractionAction.class.getResourceAsStream("LevelThree/speaker.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
